...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simpleInput = __webpack_require__(53);
	...
	var helloElement = document.getElementById('content');
	var simpleInputElement = document.getElementById('simple_input');
	var commentElement = document.getElementById('comment');

	(0, _reactDom.render)(_react2.default.createElement(_hello2.default, null), helloElement);
	(0, _reactDom.render)(_react2.default.createElement(_simpleInput2.default, null), simpleInputElement);
	(0, _reactDom.render)(_react2.default.createElement(_comment2.default, null), commentElement);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MarkdownEditor = function (_Component) {
		(0, _inherits3.default)(MarkdownEditor, _Component);

		function MarkdownEditor(props) {
			(0, _classCallCheck3.default)(this, MarkdownEditor);

			var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(MarkdownEditor).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBox = function (_Component) {
		...
		(0, _createClass3.default)(CommentBox, [{
			...
			value: function componentDidMount() {
				...
				$.getJSON('/comment').done(function (data) {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(CommentList, { comments: this.state.comments, status: this.state.status }),
	...
	var CommentList = function (_Component2) {
		...
		function CommentList() {
			...
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(CommentList).apply(this, arguments));
		}
			...
			value: function render() {
				...
				try {
					for (var _iterator = (0, _getIterator3.default)(comments), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						...
						var _comment = _step$value[1];

						commentItems.push(_react2.default.createElement(CommentElem, { key: id, comment: _comment }));
					}
				} catch (err) {
	...
	var CommentForm = function (_Component3) {
		(0, _inherits3.default)(CommentForm, _Component3);
		...
		function CommentForm() {
			...
			return _ret = (_temp = (_this3 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(CommentForm)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this3), _this3.state = {
				author: '',
				text: ''
			}, _this3.handleAuthorChange = function (event) {
				_this3.setState({ author: event.target.value });
				...
				var text = _this3.state.text.trim();
				if (!text || !author) {
					return;
				}
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { value: author, onChange: this.handleAuthorChange, type: 'text', placeholder: 'Your name' }),
						_react2.default.createElement('input', { value: text, onChange: this.handleTextChange, type: 'text', placeholder: 'Say something...' }),
	...
	var CommentElem = function (_Component4) {
		(0, _inherits3.default)(CommentElem, _Component4);

		function CommentElem() {
			(0, _classCallCheck3.default)(this, CommentElem);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(CommentElem).apply(this, arguments));
		}

		(0, _createClass3.default)(CommentElem, [{
			key: 'render',
			value: function render() {
	...
	var CommentAppContainer = _utils.Container.create(CommentBox);
	exports.default = CommentAppContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.Container = __webpack_require__(75);
	module.exports.MapStore = __webpack_require__(80);
	module.exports.Mixin = __webpack_require__(92);
	module.exports.ReduceStore = __webpack_require__(81);
	module.exports.Store = __webpack_require__(82);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStoreGroup = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxReduceStore = __webpack_require__(81);
	var Immutable = __webpack_require__(91);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStore = __webpack_require__(82);

	var abstractMethod = __webpack_require__(90);
	var invariant = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmitterSubscription = __webpack_require__(85);
	var EventSubscriptionVendor = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventSubscription = __webpack_require__(86);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immutable = __webpack_require__(91);

	var _immutable2 = _interopRequireDefault(_immutable);

	var _utils = __webpack_require__(74);

	var _comment = __webpack_require__(94);
	...
	var CommentStore = function (_ReduceStore) {
		(0, _inherits3.default)(CommentStore, _ReduceStore);

		function CommentStore() {
			(0, _classCallCheck3.default)(this, CommentStore);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(CommentStore).apply(this, arguments));
		}

		(0, _createClass3.default)(CommentStore, [{
			key: 'getInitialState',
			value: function getInitialState() {
				return {
					comments: _immutable2.default.OrderedMap(),
					status: ''
				};
			}
			...
			//		
			//		if (one.comments === two.comments && one.status === two.status) {
			//			return true;
			//		}
			//		
			//		return false;
	...
	function getCommentsFromServer(state, data) {

		var newState = $.extend({}, state);

		data.map(function (c) {
			var newComment = new _comment2.default(c.author, c.text);
	...
	function createComment(state, author, text) {
		...
		newState.status = 'ok';
		var newComment = new _comment2.default(author, text);
		newState.comments = newState.comments.set(newComment.id, newComment);
	...
	var instance = new CommentStore(_dispatcher2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentRecord = _immutable2.default.Record({
		id: undefined,
		author: undefined,
		text: undefined
	});

	var Comment = function (_CommentRecord) {
		(0, _inherits3.default)(Comment, _CommentRecord);
